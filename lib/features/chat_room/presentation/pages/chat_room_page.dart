...
class ChatRoomPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<ChatRoomBloc>(
      ...
      child: _ChatRoomView(targetUser: targetUser),
    );
  }
}

class _ChatRoomView extends StatefulWidget {
  const _ChatRoomView({required this.targetUser});
...
class _ChatRoomViewState extends State<_ChatRoomView> {
        ...
        builder: (context, state) {
          return Scaffold(
            appBar: AppBar(
              title: Row(
                children: [
                  widget.targetUser.photoUrl.isNotEmpty
                      ? CircleAvatar(
                          radius: 18,
  ...
  Widget _messagesList(ChatRoomState state, String? currentUserId) {
  ...
  Widget _composer(BuildContext context, ChatRoomState state) {
    return Container(
        ...
        child: Row(
          children: [
            Expanded(
              child: Container(
                ...
                child: TextField(
                  ...
                  onChanged: (value) =>
                      context.read<ChatRoomBloc>().add(ChatRoomInputChanged(value)),
            ...
            Container(
              ...
              child: IconButton(
                icon: state.status == ChatRoomStatus.sending
                    ? const SizedBox(
                        width: 18,
                        height: 18,
                ...
                onPressed: state.status == ChatRoomStatus.sending
                    ? null
                    : () {
